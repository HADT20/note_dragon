...
export default function MyLinksPage() {
  ...
  useEffect(() => {
    ...
    if (!userData) {
      ...
      setToastMessage('Vui lòng đăng nhập để xem link');
      setShowToast(true);
      setTimeout(() => {
        router.push('/login');
      }, 2000);
        ...
        <div className="flex-1 flex flex-col bg-[#0d2557]">
          ...
          <main className="flex-1 px-16 py-12">
            <div className="max-w-6xl mx-auto">
              {/* Header */}
              <div className="mb-8">
                <h1 className="text-4xl font-bold text-white mb-3">Quản Lý Liên Kết</h1>
                <p className="text-gray-300 text-base">
                  Tìm kiếm các liên kết đã từng được rút gọn
                </p>
              </div>
              ...
              <div className="text-center py-20">
                ...
                <button
                  onClick={() => router.push('/short-link')}
